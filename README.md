...
### new UaaLogon(clientID, domain, options)

Initializes a new instance of `UaaLogon` configured with your application `clientID` and your account's `domain` at [Auth0](https://manage.auth0.com/). You can find this information at your [application settings](https://manage.auth0.com/#/applications).
...
var lock = new UaaLogon(clientId, domain);
...
If you nevertheless decide to use it, you can activate popup mode by passing the option `auth: {redirect: false}` when constructing `UaaLogon`.
...
var lock = new UaaLogon(clientId, domain, options);
lock.show();
```
...
[npm-image]: https://img.shields.io/npm/v/uaa-logon.svg?style=flat-square
[npm-url]: https://npmjs.org/package/uaa-logon
[david-image]: http://img.shields.io/david/auth0/lock.svg?style=flat-square
[david-url]: https://david-dm.org/auth0/lock
[license-image]: http://img.shields.io/npm/l/uaa-logon.svg?style=flat-square
[license-url]: #license
[downloads-image]: http://img.shields.io/npm/dm/uaa-logon.svg?style=flat-square
[downloads-url]: https://npmjs.org/package/uaa-logon
