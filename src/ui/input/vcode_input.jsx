    ...
    return (
      <InputWrap focused={focused} isValid={isValid} name="vcode" icon={svg}>
        <input ref="input"
          type="tel"
          name="vcode"
          className="uaa-logon-input uaa-logon-input-code"
          autoComplete="off"
          autoCapitalize="off"
