...
export default class SelectInput extends React.Component {
  ...
  render() {
    ...
    if (!icon && typeof iconUrl === "string" && iconUrl) {
      icon = <img className="uaa-logon-custom-icon" src={iconUrl} />;
    }

    let className = "uaa-logon-input uaa-logon-input-location";
    if (!label) className += " uaa-logon-input-with-placeholder";
