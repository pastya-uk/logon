  ...
  render() {
    ...
    return (
      <InputWrap focused={focused} isValid={true} name="location" icon={icon}>
        <input type="button"
          name="location"
          className="uaa-logon-input uaa-logon-input-location"
          value={limitedValue}
