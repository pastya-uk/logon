...
const AuthButton = (props) => {
  ...
  let className = "uaa-logon-social-button";
  if (isBig) className += " uaa-logon-social-big-button";
  ...
  return (
    <button
      ...
      type="button"
    >
      <div className="uaa-logon-social-button-icon" style={iconStyle} />
      <div className="uaa-logon-social-button-text" style={foregroundStyle} >
        {label}
      </div>
    </button>
  );
