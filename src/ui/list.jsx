...
export default class FiltrableList extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="uaa-logon-select-country">
        <div className="uaa-logon-search">
...
class Item extends React.Component {
  ...
  render() {
    ...
    const className = highlighted ? "uaa-logon-list-code-highlighted" : "";
