...
export default class Chrome extends React.Component {
  ...
  focusError() {
    ...
    const error = node.querySelector(".uaa-logon-error input");
  ...
  render() {
    ...
    let className = "uaa-logon-cred-pane";
      ...
      <div className={className}>
        ...
        <div style={{position: "relative"}}>
          <MultisizeSlide
            ...
            reverse={reverse}
          >
            <div key={this.mainScreenName()} className="uaa-logon-view-content">
              <div style={{position: "relative"}}>
                <div className="uaa-logon-body-content">
                <div className="uaa-logon-content">
                  <div className="uaa-logon-form" ref="screen">
                    <Content focusSubmit={::this.focusSubmit} {...contentProps} />
                  </div>
                </div>
                {terms && <small className="uaa-logon-terms">{terms}</small>}
                </div>
              </div>
            </div>
          </MultisizeSlide>
